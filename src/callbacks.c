...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////nourchene//////////////////////////////////////////////////////////////////
int y1;//
int tab1[2]={0,0};//modifier
int y;//
int tab[2]={0,0};//ajouter
...
//fprintf(f,"%s %s %s %s %d/%d/%d %s %s\n",t.cin,t.service,t.numerochambre,t.date, jj1,mm1+1,aa1 ,t.nometprenom,t.reclamation);
...
// afficher le servicebre de resultats obtenue par la recherche
